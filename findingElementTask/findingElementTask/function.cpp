...
void insertSort(int array[], int n, int left, int right)
{
...
int sortArrayForOneNumber(int array[], int middleNumber, int left, int right)//this function need to find position of middle element
{
	int position = 0;
	int i = left;
